...
class GestureTest(object):
    ...
    def init_model(self):
        ...
        self.data_loader = DataLoader(
            Dataset(self.configer, self.data_path, self.npz,split="test", data_type=self.data_type,
    ...
    def __test(self):
        ...
        with torch.no_grad():
            for i, data_tuple in enumerate(tqdm(self.data_loader, desc="Test")):
                ...
                one_features = f.cpu().detach().numpy().reshape(-1)
                one_epoch_features.append(one_features)
